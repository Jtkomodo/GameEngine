...
public class AABB {
	...
	public static final int OFF=0,SHOW_DATA=1,SHOW_ONLY_ID=3;

	private int DEBUG_MODE=OFF;
    ...
    lc             		
		...
		Offsetpostion.x=(point.x-lc.x)/2;
		Offsetpostion.y=((height*2)-(point.y-lc.y))/2;	
	...
	public void DEBUG_SHOW_DATA() {
		this.DEBUG_MODE=SHOW_DATA;
	}

	public void DEBUG_SHOW_ONLY_ID() {
		this.DEBUG_MODE=SHOW_ONLY_ID;
	}
